...
#     name                        = "${module.naming["${each.key}_${split("_", k)[0]}"].virtual_network.name}-${try(split("_", k)[1])}"
#     resource_group_name         = "${module.naming["${each.key}_${split("_", k)[0]}"].resource_group.name}-infra-${try(split("_", k)[1])}"
...
#     name                = "${module.naming["${each.key}_${v.region}"].resource_group.name}-${split("_", k)[0]}-${try(split("_", k)[1])}"
